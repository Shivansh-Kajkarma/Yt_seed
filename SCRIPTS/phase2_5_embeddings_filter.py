...
# try:
#     # --- DEPRECATED: Phase 2.5 is no longer used in new pipeline architecture ---
...
#     print(
#         "⚠️ WARNING: Phase 2.5 is deprecated. Use Phase 3 Step 3B (OpenAI embeddings) instead."
#     )
...
# # DEPRECATED: embedding_model not used
...
#             cand_video_titles = (
#                 df_cand_videos.get("title", pd.Series()).dropna().tolist()
#             )
#             cand_video_descs = (
#                 df_cand_videos.get("description", pd.Series()).dropna().tolist()
#             )
...
#         by="Score_Emb_Combined_AvgVec", ascending=False
#     )
...
#         )
#         print(
#             f"✅ Mongo: {len(df_report)} scored channels upserted to '{run_tag.upper()}_phase2_5'."
#         )
#     except Exception as e:
