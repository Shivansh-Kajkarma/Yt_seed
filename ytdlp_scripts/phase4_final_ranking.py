...
def main():
    ...
    for index, row in df_merged.iterrows():
        ...
        # RULE 4: Below 0.70 → Tier 3 (Rejected)
        else:
            row_dict["Final_Tier"] = 3
            row_dict["Final_Status"] = "Tier 3 (Low Content Score)"
            final_results.append(row_dict)
    ...
    with ThreadPoolExecutor(max_workers=5) as executor:
        ...
        for future in as_completed(future_to_row):
            ...
            if is_match:
                ...
                row_dict["Final_Tier"] = 3
                row_dict["Final_Status"] = "Tier 3 (LLM Rejected)"
    ...
    print(f"\n💾 Saved final ranked results to '{collection_out}'")

    # Filter to specific columns for CSV export
    # csv_columns = [
    #     "Discovered_Channel_ID",
    ...
    # available_columns = [col for col in csv_columns if col in df_final.columns]
    # df_csv = df_final[available_columns]
